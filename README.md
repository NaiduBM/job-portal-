...
- Frontend server will start on port 5000.
- Now open `http://localhost:5000/` and proceed creating jobs and applications by signing up in required categories.
...
- Terminal: Bash
- Processor: Intel Core i5-1155G7 @ 2.50GHz   2.50 GHz
- RAM: 16 GB
